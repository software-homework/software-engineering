...
public class FinanceFrame extends JFrame implements ActionListener, MouseListener{
	...
	JTable table;
	JScrollPane sp;
	public JScrollPane createTable(ArrayList<AccountVO> data1, String[][] data2, String[][] data3, String[][] data4, String[][] data5){
		String[][] data = null;
	...
	public void mouseClicked(MouseEvent arg0) {
		if(arg0.getClickCount() == 2){
			...
			if(id.split("-")[0].equals("SKD")){
				...
				LedgerVO ledgerVO = accountBL.findOneLedger(id.split("/")[0].toString() + id.split("/")[1].toString() + id.split("/")[2].toString());
