...
public class StockMain extends JFrame {
	...
	public StockMain(UserVO user){
									...
									if(cv.commodityList.size() == 0){
										...
										jmi2.addMouseListener(new MouseAdapter(){
											public void mouseReleased(MouseEvent e){
												new AddCategory(StockMain.this);
											}
										});
										jpm.add(jmi2);
										...
										jmi1.addMouseListener(new MouseAdapter(){
											public void mouseReleased(MouseEvent e){
												new AddCommodity(StockMain.this);
											}
										});
										jpm.add(jmi1);
										...
										jmi10.addMouseListener(new MouseAdapter(){
											public void mouseReleased(MouseEvent e){
												new UpdateCategory(StockMain.this);
											}
										});
										jpm.add(jmi10);
				...
				if (e.getButton() == MouseEvent.BUTTON3){
					if(table.getSelectedRowCount() > 0){
						...
						jmi.addMouseListener(new MouseAdapter(){
							public void mouseReleased(MouseEvent e){
								new UpdateCommodity(StockMain.this);
							}
						});
						jpm.add(jmi);
		...
		item1.addMouseListener(new MouseAdapter(){
			public void mouseReleased(MouseEvent e){
				new FindCommodity(StockMain.this);
			}
		});
		
		item2.addMouseListener(new MouseAdapter(){
			public void mouseReleased(MouseEvent e){
				new ShowStock(StockMain.this);
			}
		});
		...
		item4.addMouseListener(new MouseAdapter(){
			public void mouseReleased(MouseEvent e){
				new SendPresent(StockMain.this);
			}
		});
		
		item5.addMouseListener(new MouseAdapter(){
			public void mouseReleased(MouseEvent e){
				new MessageMain(StockMain.this);
			}
		});
		...
		item8.addMouseListener(new MouseAdapter(){
			public void mouseReleased(MouseEvent e){
				new CheckStockOverflow(StockMain.this);
				LogBLService lbs = new LogBL();
		...
		item9.addMouseListener(new MouseAdapter(){
			public void mouseReleased(MouseEvent e){
				new CheckStockLoss(StockMain.this);
				LogBLService lbs = new LogBL();
		...
		item10.addMouseListener(new MouseAdapter(){
			public void mouseReleased(MouseEvent e){
				new CheckPresent(StockMain.this);
				LogBLService lbs = new LogBL();
...
//					update();
	...
	public void stockOverflow(JPopupMenu jpm){
		...
		jmi.addMouseListener(new MouseAdapter(){
			public void mouseReleased(MouseEvent e){
				new StockOverflow(StockMain.this);
			}
		});
		jpm.add(jmi);
	}
