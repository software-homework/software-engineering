...
public class StocksnapData extends UnicastRemoteObject implements StocksnapDataService{
	...
	private StocksnapData()throws RemoteException{
		stocksnapList = new ArrayList<StocksnapPO>();
		readFromFile();
	}
	
	public static StocksnapData getInstance()throws RemoteException{
		if(ssd == null){
