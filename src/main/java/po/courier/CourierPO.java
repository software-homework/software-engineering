...
public class CourierPO implements Serializable{
	...
	public CourierPO(String ID,String customer,int repertory,String user,ArrayList<CommodityPO> SalesList,double pretotal,double discount,double voucher,double posttotal,String remakes,int approval){
		setID(ID);
