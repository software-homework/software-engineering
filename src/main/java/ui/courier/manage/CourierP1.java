...
import businesslogic.courier.GetCommodity;
...
public class CourierP1 extends JPanel{
	...
	CourierVO salesvo;
	public CourierP1(AddSalesFrame asf){
		addSalesframe=asf;
	...
	public CourierP1(AddSalesFrame asf,CourierVO svo){
		addSalesframe=asf;
		salesvo=new CourierVO();
		salesvo=svo;
		this.setLayout(new BorderLayout());
		//表格
	...
	private class nextListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			addSalesframe.panel2=new CourierP2(newdata,addSalesframe);
	...
	private class rnextListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			addSalesframe.panel2=new CourierP2(newdata,addSalesframe,salesvo);
			addSalesframe.panel1.setVisible(false);
			addSalesframe.panel1.setEnabled(false);
			addSalesframe.add(addSalesframe.panel2,BorderLayout.CENTER);
		}
