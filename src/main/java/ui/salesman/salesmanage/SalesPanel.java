...
public class SalesPanel extends JPanel{
	...
	SalesMain salesmain;
	public SalesPanel(SalesMain sm){
		sbl=new SalesBL();
		salesmain=sm;
	...
	public void setData(){
		ArrayList<SalesVO> list=sbl.ShowS();
	...
	class addSalesListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			if(sbl.getsID().trim().equals(null)){
				...
				new AddSalesFrame(sbl.getsID(),SalesPanel.this,null);
			}
		}
	}
	...
	class addSalesRListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			if(sbl.getsrID().trim().equals(null)){
				...
				new AddSalesFrame(sbl.getsrID(),SalesPanel.this,sbl.findSales(data[selectrow][0]));
			}
		}
	}
